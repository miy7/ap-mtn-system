...
export default async function EquipmentPage() {
  ...
  const { data: assetRows } = await supabase.from('assets').select('id, asset_number, name, system_type, customer_id, customers(name), customer_sites(name, address)').order('created_at', { ascending: false })
